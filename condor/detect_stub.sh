...
#
# Design decision R22 scoped this to three names (pandas, requests, PIL). Design decision R34
...
# base already ships all three. Design decision R35 corrected the scope again: the
...
#
# Design decision R37: the R35-scoped job actually ran (cluster 9686702) and failed
